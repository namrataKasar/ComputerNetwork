...
LogNormalPropagationLossModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LogNormalPropagationLossModel")
    ...
    .AddAttribute ("ReferenceLoss",
                   ...
                   MakeDoubleChecker<double> ())
    .AddAttribute ("NormalRandomVariable",
                   "Gaussian random normal variable (X)",
                                                ...
                                                Ptr<MobilityModel> b) const
{
    ...
    double gaussianRandomVariable = m_randVariable->GetValue();
    ...
    double PL = 10 * m_exponent * std::log10(distance/m_referenceDistance) - gaussianRandomVariable;
    double rx = -m_referenceLoss - PL;
    return txPowerDbm + rx;
}
